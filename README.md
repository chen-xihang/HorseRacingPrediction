...
and tests whether these variables improve prediction after accounting for Betfair
Starting Price (BSP). Performance is evaluated out-of-sample using probabilistic
metrics (log loss, Brier score, calibration) and simulated betting returns with
confidence intervals, with a focus on economically meaningful residual edge.